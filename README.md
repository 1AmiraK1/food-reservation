...
<div class="alert">(توجه داشته باشید که این پروژه، یک پروژه تست و دمو است و بسیاری از بخش های آن هنوز توسعه نیافته)</div>
...
- [🚀 راه‌اندازی و نصب (به صورت محلی)](#🚀-راه‌اندازی-و-نصب-به-صورت-محلی)
...
## 🚀 راه‌اندازی و نصب (به صورت محلی)

برای راه‌اندازی این پروژه به صورت محلی، مراحل زیر را دنبال کنید:

<div class="alert">ابتدا مطمئن شوید که روی دستگاه خود MongoDB را نصب دارید. درغیر اینصورت می‌توانید برای اجرای برنامه به مرحله بعد (راه اندازی با استفاده از داکر) مراجعه کنید.</div>
...
2.  برای توقف سرویس‌ها از دستور `docker compose down` استفاده کنید.
